...
func Run() {
	util.AssertResult("Part 1 example.txt", runPartOne("./internal/day_2/example.txt"), "4361")
	util.AssertResult("Part 1 input.txt", runPartOne("./internal/day_2/input.txt"), "")

	//util.AssertResult("Part 2 example.txt", runPartTwo("./internal/day_2/example.txt"), "")
