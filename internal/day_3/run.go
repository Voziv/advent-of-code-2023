...
func Run() {
	...
	util.AssertResult("Part 2 example.txt", runPartTwo("./internal/day_3/example.txt"), "467835")
	util.AssertResult("Part 2 input.txt", runPartTwo("./internal/day_3/input.txt"), "84584891")
}
